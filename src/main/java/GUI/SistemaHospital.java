...
import GUI.utilidades.PButton;
import GUI.utilidades.PMenuConsultas;
import GUI.utilidades.PMenuMedicos;
import GUI.utilidades.PMenuPacientes;
...
public class SistemaHospital extends JFrame {
    ...
    private SistemaHospital() {
        ...
        setIconImage(new ImageIcon("src/main/java/GUI/icons/icono-hospital.png").getImage());
    ...
    private void initComponents() {
        ...
        PButton imgMenu = new PButton("src/main/java/GUI/icons/icono-menu.png", "");
        PButton imgHospital = new PButton("src/main/java/GUI/icons/icono-hospital-negativo.png", "");
        ...
        PButton imgInformacion = new PButton("src/main/java/GUI/icons/icono-info.png", "");
        ...
        PButton btnConsultas = new PButton("src/main/java/GUI/icons/icono-consulta.png", "consultas");
        PButton btnPacientes = new PButton("src/main/java/GUI/icons/icono-paciente.png", "pacientes");
        PButton btnDoctores = new PButton("src/main/java/GUI/icons/icono-doctor.png", "doctores");
        PButton btnEquipo = new PButton("src/main/java/GUI/icons/icono-equipo.png", "equipo medico");
